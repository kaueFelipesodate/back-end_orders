...
/**
 * Interceptor to validate all HTTP requests against SQL Injection
 * Intercepts requests before they reach the controllers
 */
@Component
...
public class SqlInjectionValidationInterceptor implements HandlerInterceptor {
    ...
    /**
     * Gets the client's real IP considering proxies
     */
